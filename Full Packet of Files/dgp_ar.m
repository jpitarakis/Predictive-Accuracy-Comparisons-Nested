function [y,X] = dgp_ar(n,p,k,sigsq_u,correl_uv,Omega_vv,Phimat,beta0,rho,beta1)

% 
% This function simulated data from the following DGP: 
% ========================================================================
% y(t) = beta0 + rho*y(t-1) + x(t-1)'beta1 + u(t)
...
% rho = AR coefficient in the dgp 
% 
% Outputs:
%
% Outcome series y. 
%
% Example usage: y(t) = 1 + 0.25 y(t-1) + 0.5 x1(t-1) + 0.25 x2(t-1) + u(t) 
% X(t) = (x1(t),x2(t)
...
[nx,~] = size(X);
y(2:n) = beta0 + rho*y(1:n-1)+X(1:nx-1,:)*beta1+u(2:nx);
